  ...
  return (
    <div className="mx-auto max-w-2xl px-4 pt-6 pb-24">
      ...
      <p className="mt-1 text-xs text-zinc-500">
        Sorted by arrival time. Update yours under <Link href="/me/edit" className="text-yellow-400 hover:text-yellow-300">/me/edit</Link>.
      </p>
      ...
      <section className="mt-8">
        ...
        <div className="mt-3 space-y-2">
          {withFlights.length === 0 ? (
            ...
            withFlights.map((m) => (
              <FlightCard key={m.id} member={m} teamById={teamById} />
            ))
          )}
        </div>
      </section>

              ...
              <button
                ...
                className={`shrink-0 rounded-sm border px-3 py-1.5 ${
                  isActive
                    ...
                    : 'border-zinc-200 dark:border-zinc-800 bg-white dark:bg-black hover:border-zinc-700'
                }`}
              >
                <span
                  className={`font-mono text-[10px] font-semibold uppercase tracking-widest ${
                    isActive ? 'text-yellow-400' : 'text-zinc-500 dark:text-zinc-400'
                  }`}
                >
                  {p.nickname}
                  {p.isSelf && ' (you)'}
...
function ViewToggle({
  ...
  return (
    <div className="flex rounded-sm border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-black p-0.5">
      <button
        type="button"
...
function HoleByHole({
  ...
  return (
    <div className="mt-3">
      <div
        className="flex items-center justify-between gap-4 rounded-sm border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950/60 px-4 py-2.5"
        style={{
          background:
      ...
      >
        ...
        <div className="flex items-center gap-3 font-mono text-[10px] uppercase tracking-widest text-zinc-500 dark:text-zinc-400 tabular-nums">
          <span>
            <span className="text-zinc-600">Par </span>
            <span className="text-zinc-600 dark:text-zinc-200">{hole.par}</span>
          </span>
          {hole.yardage != null && (
            <span>
              <span className="text-zinc-600">Yd </span>
              <span className="text-zinc-600 dark:text-zinc-200">{hole.yardage}</span>
            </span>
          )}
          <span>
            <span className="text-zinc-600">SI </span>
            <span className="text-zinc-600 dark:text-zinc-200">{hole.handicapIndex}</span>
          </span>
        </div>
      </div>
      ...
      <div className="mt-3 flex gap-2">
        <button
          ...
          onClick={onPrev}
          disabled={!canPrev}
          className="flex flex-1 items-center justify-center gap-1 rounded-sm border border-zinc-400 dark:border-zinc-700 px-4 py-2.5 font-mono text-xs font-semibold uppercase tracking-widest text-zinc-500 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-900 disabled:opacity-40"
        >
...
function PlayerHoleRow({
  ...
  return (
    <div
      className="flex items-center gap-2 rounded-sm border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950/40 p-2"
...
function CardView({
  ...
  return (
    <div className="mt-6 rounded-sm border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950/40">
      <div className="grid grid-cols-[28px_28px_28px_28px_1fr_56px] items-center gap-2 border-b border-zinc-200 dark:border-zinc-800 px-3 py-2 font-mono text-[9px] font-semibold uppercase tracking-widest text-zinc-500">
        <span>#</span>
        <span>Par</span>
        <span>Yds</span>
        <span>SI</span>
      ...
      {holes.map((h) => {
        ...
        return (
          <div
            key={h.number}
            className="grid grid-cols-[28px_28px_28px_28px_1fr_56px] items-center gap-2 border-b border-zinc-100 dark:border-zinc-900 px-3 py-2 last:border-b-0"
          >
            <span className="font-mono text-sm font-bold tabular-nums text-yellow-400">
              {h.number}
            </span>
            <span className="font-mono text-xs tabular-nums text-zinc-500 dark:text-zinc-300">
              {h.par}
            </span>
      ...
      <div className="grid grid-cols-[28px_28px_28px_28px_1fr_56px] items-center gap-2 border-t-2 border-zinc-400 dark:border-zinc-700 px-3 py-3 font-mono text-xs font-semibold uppercase tracking-widest">
        ...
        <span className="text-zinc-500 dark:text-zinc-300">{totalPar}</span>
        <span />
        <span />
...
function CardScoreInput({
  ...
  return (
    <input
      ...
      className="w-full rounded-sm border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-black px-2 py-1 text-right font-mono text-sm tabular-nums focus:border-yellow-500 focus:outline-none"
    />
  );
}
...
function TeamScoreEntry({
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 pb-24 pt-3">
      <div className="mt-2 flex items-center justify-between gap-4 rounded-sm border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950/60 px-4 py-2.5">
        <div className="flex items-baseline gap-2">
          <span className="font-mono text-[9px] font-semibold uppercase tracking-[0.3em] text-zinc-500">
            Hole
          </span>
        ...
        <div className="flex items-center gap-3 font-mono text-[10px] uppercase tracking-widest text-zinc-500 dark:text-zinc-400 tabular-nums">
          <span>
            <span className="text-zinc-600">Par </span>
            <span className="text-zinc-600 dark:text-zinc-200">{activeHoleData.par}</span>
          </span>
          {activeHoleData.yardage != null && (
            <span>
              <span className="text-zinc-600">Yd </span>
              <span className="text-zinc-600 dark:text-zinc-200">{activeHoleData.yardage}</span>
            </span>
          )}
          <span>
            <span className="text-zinc-600">SI </span>
            <span className="text-zinc-600 dark:text-zinc-200">{activeHoleData.handicapIndex}</span>
          </span>
        </div>
      </div>
  ...
  return (
    ...
    >
      <div className="min-w-0 flex-1">
        ...
        <p className="truncate text-xs text-zinc-500 dark:text-zinc-400">{team.memberLine}</p>
        <div className="mt-0.5 flex items-center gap-1.5">
          {score != null ? (
            <>
              {net != null && net !== score && (
